  ...
  return (
    <div className="bg-[url('../../public/bg2.png')] bg-no-repeat h-screen bg-cover text-white">
      <div className="flex flex-col justify-center items-center gap-2 pt-5 sm:pt-10">
        <div>
          <Image src={s1} className="inline pr-2" />
      ...
      <div className="flex xl:flex-row flex-col  justify-center items-center gap-20 relative sm:mt-5   animate-myfirst"> 
        <div className="flex flex-col gap-8 pt-2 sm:pt-10  animate-myfirst">
          <div className="bg-white inline-flex rounded-lg px-10 z-10 ">
            <Image src={s2} width={"94"} height={"94"} />
            <div>
              <p className="text-[#1F1F1F] font-bold text-[52px]">110+</p>
          ...
          <div className="bg-white inline-flex rounded-lg px-10 z-10 ">
            <Image src={s3} width={"94"} height={"94"} />
            <div>
              <p className="text-[#1F1F1F] font-bold text-[52px]">11+</p>
              <p className="text-[#898989] font-medium text-[18px]">
                Years Of Experience
              </p>
            </div>
        ...
        <div className="opacity-25 xl:opacity-100 absolute top-0 xl:relative z-0 animate-spin">
          <Image src={fan} />
        </div>
        <div className="flex flex-col gap-8 absolute top-[110%] xl:relative">
          <div className="bg-white inline-flex rounded-lg px-10 ">
            <Image src={s4} width={"94"} height={"94"} />
            <div>
              <p className="text-[#1F1F1F] font-bold text-[52px]">90+</p>
              <p className="text-[#898989] font-medium text-[18px]">
                Professional Staff
              </p>
            </div>
          ...
          <div className="bg-white inline-flex rounded-lg px-10 ">
            <Image src={s5} width={"94"} height={"94"} />
            <div>
              <p className="text-[#1F1F1F] font-bold text-[52px]">170+</p>
              <p className="text-[#898989] font-medium text-[18px]">
                Happy Clients
              </p>
            </div>
